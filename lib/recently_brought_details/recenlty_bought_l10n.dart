...
class RecentlyBoughtL10n {
  static final Map<String, Map<_LKeys, String>> _localizedValues = {
    L10nService.enUS.toString(): {
      ...
      _LKeys.NoProductsAvailable: "Ordered with nothing else",
    ...
    L10nService.ptZh.toString(): {
      ...
      _LKeys.NoProductsAvailable: "没有其他的命令",
  ...
  RecentlyBoughtL10n(this.locale);

  static const LocalizationsDelegate<dynamic> delegate =
      _RecentlyBoughtL10nDelegate();
}

class _RecentlyBoughtL10nDelegate extends AL10nDelegate<RecentlyBoughtL10n> {
  const _RecentlyBoughtL10nDelegate();

  @override
  Future<RecentlyBoughtL10n> load(Locale locale) =>
      SynchronousFuture<RecentlyBoughtL10n>(RecentlyBoughtL10n(locale));
}
