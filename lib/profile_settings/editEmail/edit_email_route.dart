...
import 'package:market_space/profile_settings/editEmail/edit_email_screen.dart';
import 'package:market_space/routes/route.dart';

class EditEmailRoute extends ARoute {
  static String _path = '/settings/editEmail';
