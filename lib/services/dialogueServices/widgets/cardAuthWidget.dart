...
class _Complete2FAWidget extends StatefulWidget {
  const _Complete2FAWidget({Key key}) : super(key: key);

  @override
  _Complete2FAWidgetState createState() => _Complete2FAWidgetState();
}

class _Complete2FAWidgetState extends State<_Complete2FAWidget> {
